...
class SaveFeaturedDeals extends UseCase<void, Map<String, dynamic>> {
  final ParityCubeRepository _parityCubeRepository;

  SaveFeaturedDeals(this._parityCubeRepository);

  @override
  Future<Either<AppError, void>> call(Map<String, dynamic> response) async =>
      _parityCubeRepository.saveFeaturedDeals(response: response);
}
